...
О том как я писал консольную приложеньку на совершенно новом для себя языке.
...
А ещё он тупой как пробка и это хорошо, потому что сайт собирается чертовски быстро
...
А вот чего в Zola нет, так это генерации превьюшек для соцсетей. Проблема и правда есть, но вот автор фреймворка не считает необходимым это добавлять, а красоты хочется, поэтому мне пришлось воротить своё решение.
...
Он не хранит изображения на диске, а генерирует их на лету по запросу пользователя, при том преобразовывая JSX-код в SVG. Звучит довольно замороченно, хотя работает и правда весьма быстро.
