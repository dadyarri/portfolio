...
description: 'Как запустить дашборд и настроить сбор логов и метрик в бэкенде, который не использует Aspire'
published: false
...
В недавно вышедшем [Preview 4](https://learn.microsoft.com/en-us/dotnet/aspire/whats-new/preview-4) в числе прочего добавили возможность запустить дашборд отдельно от Aspire. В этой статье я попробую добавить дашборд к своему .NET-бэкенду.
...
<Image src={logs} alt={"Дашборд с собранными логами"}/>