...
Впоследствии даже появилась мысль интегрировать это решение в Zola, но для этого мне пришлось бы перелопатить половину весьма запутанной кодовой базы этого генератора. Но поскольку я не слишком глубоко погрузился в Rust и в какой-то момент он начал генерировать весьма странные ошибки, опыта и времени разбираться в которых мне не доставало, пришлось эту идею отбросить.
