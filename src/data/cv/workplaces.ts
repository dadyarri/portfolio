...
export default [
    ...
    },
    {
        ...
        description: [
            "Расширил функциональность библиотеки FlexLabs.Upsert с открытым исходным кодом, внедрив поддержку OracleDB, что позволило значительно повысить её универсальность и применимость в разнообразных проектах",
            "Успешно перевёл архитектуру микросервиса чата с использования файлового хранилища на базы данных, обеспечив высокую доступность, надёжность сервиса и возможность репликации, что значительно улучшило масштабируемость и стабильность сервиса"
        ]
    }
] satisfies Workplace[]